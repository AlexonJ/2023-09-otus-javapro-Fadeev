package ru.otus.javapro.homeworks.hw11jpql.base;
...
import ru.otus.javapro.homeworks.hw11jpql.core.repository.DataTemplateHibernate;
import ru.otus.javapro.homeworks.hw11jpql.core.repository.HibernateUtils;
import ru.otus.javapro.homeworks.hw11jpql.core.sessionmanager.TransactionManagerHibernate;
import ru.otus.javapro.homeworks.hw11jpql.crm.dbmigrations.MigrationsExecutorFlyway;
import ru.otus.javapro.homeworks.hw11jpql.crm.model.Client;
import ru.otus.javapro.homeworks.hw11jpql.crm.service.DBServiceClient;
import ru.otus.javapro.homeworks.hw11jpql.crm.service.DbServiceClientImpl;

import static ru.otus.javapro.homeworks.hw11jpql.demo.DbServiceDemo.HIBERNATE_CFG_FILE;
